...
// <i> Default: 1
// Disabled for production power: keeping PD0B on in EM2 costs several hundred
// µA. Set back to 1 if a debug session must survive EM2 entry.
#define SL_DEVICE_INIT_EMU_EM2_DEBUG_ENABLE   0
