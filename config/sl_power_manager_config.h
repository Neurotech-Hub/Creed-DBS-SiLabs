...
// <i> Default: 0
// Set to 1 to diagnose sleep blockers: tracks which modules hold EM1/EM2
// requirements (inspect requirement_em_table via debugger, see readme).
// Used Jul 2026 to find the missing device_init_lfrco component. Keep 0 in
// production.
#define SL_POWER_MANAGER_DEBUG  0

// <o SL_POWER_MANAGER_DEBUG_POOL_SIZE> Maximum numbers of requirements that can be logged
// <i> Default: 10
#define SL_POWER_MANAGER_DEBUG_POOL_SIZE  16
// </e>
